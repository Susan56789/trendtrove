    ...
    <div class="h-screen flex">
        <div class="hidden lg:flex w-full lg:w-1/2 login_img_section
            ...
            <div class="w-full mx-auto px-20 flex-col items-center space-y-6">
                ...
                <p class="text-white mt-1">One order away!</p>
                <div class="flex justify-center lg:justify-start mt-6">
                    <a href="/shop" class="hover:bg-indigo-700 hover:text-white hover:-translate-y-1 transition-all duration-500 bg-white 
                                                    text-indigo-800 mt-4 px-4 py-2 rounded-2xl font-bold mb-2">Shop
                        Now!</a>
                </div>
            </div>
        </div>
        <div class="flex w-full lg:w-1/2 justify-center items-center bg-yellow-50 space-y-8">
...
<style>
.login_img_section {
    background: linear-gradient(rgba(2, 2, 2, .7), rgba(0, 0, 0, .7)), url(https://creazilla-store.fra1.digitaloceanspaces.com/emojis/46515/shopping-cart-emoji-clipart-md.png) center center;
}
</style>
...
export default {
    ...
    methods: {
        login() {
            ...
            console.log(`Logged in with email: ${this.email} and password: ${this.password}`);
        },
    },
};
</script>