        ...
        <div class="mx-6 py-10 text-center md:text-left">
            <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div class="">
                    ...
                    <p>
                        Trend Trove is an online shopping platform that provides a wide range of products for
                ...
                <div class="">
                    ...
                    <p class="mb-4">
                        <a href="/shop" class="text-neutral-600 dark:text-neutral-200">Shop</a>
                    </p>
                    <p class="mb-4">
                        <a href="/about" class="text-neutral-600 dark:text-neutral-200">About</a>
                    </p>
                    <p class="mb-4">
                        <a href="/contact" class="text-neutral-600 dark:text-neutral-200">Contact</a>
                    </p>
                    <p>
